"""Authorization endpoint — v09 complete in v10 scaffold; no v10 authorize changes.

RFC 8707 `resource` on authorize is implemented. Token exchange (v10) uses POST /token only.
"""
