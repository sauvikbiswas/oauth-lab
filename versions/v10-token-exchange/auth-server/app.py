...
# Repo root on path so `shared` imports work when running from auth-server/
...
from routes.introspect import introspect_bp
...
def create_app() -> Flask:
    ...
    def inject_lab_context():
        return {"lab_version": "v10", "lab_role": "auth-server"}
